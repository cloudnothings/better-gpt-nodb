  ...
  return (<>
    <div className="relative w-full">
      <textarea
        ...
        className='relative block w-full rounded-md p-2 border-0 text-gray-900 shadow-md placeholder:text-gray-400 sm:py-1.5 sm:leading-6 max-h-[500px] resize-none overflow-auto dark:bg-zinc-600  outline-0 dark:text-white'
        value={message}
        disabled={isLoading}
        onChange={(e) => {
